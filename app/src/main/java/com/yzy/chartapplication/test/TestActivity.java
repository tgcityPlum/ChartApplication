package com.yzy.chartapplication.test;
...
public class TestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pie_chart.setUsePercentValues(true);// 1
        pie_chart.getDescription().setEnabled(false);
        pie_chart.setExtraOffsets(0.f, 10.f, 0.f, 10.f);

        pie_chart.setDragDecelerationFrictionCoef(0.95f);
        pie_chart.setCenterText("图表");// 1

        pie_chart.setDrawHoleEnabled(true);// 1
        pie_chart.setHoleColor(Color.WHITE);// 1  //中间圆颜色
        pie_chart.setTransparentCircleColor(Color.WHITE);// 1
        pie_chart.setTransparentCircleAlpha(110);// 1

        pie_chart.setHoleRadius(40f); // 1  //圆半径
        pie_chart.setTransparentCircleRadius(44f);// 1
        pie_chart.setDrawCenterText(true);// 1
...
//            }
//        }
        PieEntry sz = new PieEntry(30f, "深圳0");
